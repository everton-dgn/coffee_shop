...
const BeansData = [
  {
    ...
    imageLinkSquare: require('assets/images/coffee/robustaCoffeeBeans/robustaCoffeeBeansSquare.png'),
    imageLinkPortrait: require('assets/images/coffee/robustaCoffeeBeans/robustaCoffeeBeansPortrait.png'),
    ingredients: 'Africa',
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imageLinkSquare: require('assets/images/coffee/arabicaCoffeeBeans/arabicaCoffeeBeansSquare.png'),
    imageLinkPortrait: require('assets/images/coffee/arabicaCoffeeBeans/arabicaCoffeeBeansPortrait.png'),
    ingredients: 'Africa',
    special_ingredient: 'From Africa',
    prices: [
      { size: '250gm', price: '5.50', currency: '$' },
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imageLinkSquare: require('assets/images/coffee/libericaCoffeeBeans/libericaCoffeeBeansSquare.png'),
    imageLinkPortrait: require('assets/images/coffee/libericaCoffeeBeans/libericaCoffeeBeansPortrait.png'),
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imageLinkSquare: require('assets/images/coffee/excelsaCoffeeBeans/excelsaCoffeeBeansSquare.png'),
    imageLinkPortrait: require('assets/images/coffee/excelsaCoffeeBeans/excelsaCoffeeBeansPortrait.png'),
    ingredients: 'Malaysia',
    special_ingredient: 'From Malaysia',
    prices: [
      { size: '250gm', price: '5.50', currency: '$' },
